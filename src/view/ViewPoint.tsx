      ...
      {gameEnded && (
        <div className="absolute inset-0 bg-white/80 flex items-center justify-center z-20">
          <div className="bg-white border border-pink-400 rounded-xl p-8 w-full max-w-sm text-center shadow-xl">
            ...
            <button
              onClick={saveScore}
              className="bg-pink-500 hover:bg-pink-600 text-white py-2 px-6 rounded-lg font-semibold transition-transform hover:scale-105"
            >
              Guardar y salir
            </button>
            <div>
            <button
              onClick={()=> navigate('/')}
              className="mt-2 bg-pink-500 hover:bg-pink-600 text-white py-2 px-6 rounded-lg font-semibold transition-transform hover:scale-105"
            >
              salir
            </button>
            </div>
